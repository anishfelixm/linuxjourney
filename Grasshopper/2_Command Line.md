...
> $cd
>
> Just this command goes to root directory
...
**file**
  ...
  Normally, like in Windows, files will have file extensions such as .jpeg, .gif, etc. This isn't required in Linux, ie filenames are not required to represent the type of content in file. So we can have a .gif file without the filename being .gif. To get the type of file, use the "**file**" command.
Syntax :
> $file banana.jpg
